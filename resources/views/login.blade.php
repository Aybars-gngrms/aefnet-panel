...
<body class="dark-edition off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="page-header register-page header-filter" filter-color="black"
            style="background-image: url('{{ asset('backend') }}/assets/img/loading.png')">
            <div class="container">
                <div class="row">
                        ...
                        <div class="card" style="opacity: 0.9;">
                            <div class="card-header card-header-primary text-center">
                                <h2 class="card-title" style="font-weight:bold;">
                                    {{ $config->admin_panel_login_form_title }}</h2>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 ml-auto mr-auto">
                                        <form class="form" action="{{ route('login.post') }}" method="POST">
                                            ...
                                            <div class="form-group text-left ml-5" style="font-weight:bold;">
                                                <a href="{{ route('login.forgot') }}">Şifremi Unuttum</a>.
                                            </div>
                                            <div class="text-right">
                                                <button type="submit" class="btn btn-success mt-4">Giriş Yapın</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
